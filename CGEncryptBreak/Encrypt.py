...
#     return aes_decrypt(data, pwd_aes_key2).strip()
...
def aes_encrypt(data, key):
    ...
    encoded_data = base64.encodebytes(encrypted_data).decode()
    return encoded_data


def aes_decrypt(encoded_data, key):
    cipher = AES.new(key, AES.MODE_ECB)
    encrypted_data = base64.decodebytes(encoded_data.encode())
...
if __name__ == '__main__':
    ...
    # AAAANBKGhnL7dg1r
    # AAAANMrcrjMalNof
    print(aes_decrypt(unquote(string), b"AAAANG4EOnTybYEj"))
